...
|------|--------|------|----------|----------|----------|-------------|
| 01 | L01_intro | 认识C程序 | C程序结构、main函数、编译流程、printf | Hello World、多行文本输出、程序名片 | 修改输出内容、三行文本输出 | 待补代码 |
| 02 | L02_data-types | 标识符与数据类型 | 标识符命名、常量/变量、int/float/double/char、sizeof | 合法标识符辨析、变量初始化、sizeof对比 | 声明不同类型变量并sizeof输出 | 待补代码 |
| 03 | L03_sequential-programming | 运算符与顺序结构 | 算术/关系/逻辑运算符、自增自减、printf/scanf | 优先级拆解、圆面积计算、两数求和 | 输入半径计算圆面积 | 待补代码 |
...
| 状态 | 数量 | 说明 |
|------|------|------|
| 已有代码 | 0 | 仓库初始化，尚无可运行代码 |
| 待补代码 | 16 | 全部16讲均需从零编写课堂案例代码 |
| 待验证 | 0 | — |
| 已定稿 | 0 | — |
