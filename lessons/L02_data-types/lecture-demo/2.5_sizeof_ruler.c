/*
 * 文件名: 2.5_sizeof_ruler.c
 * 对应课件: 第02讲 PPT 第18、19页【sizeof：探秘内存物理“量地尺”】
 * 对应教材: 谭浩强版《C程序设计》第2章 + 何钦铭版《C语言程序设计》第2章
 * 适用环境: Visual Studio / Dev-C++ / VS Code
 * 
 * 核心教学目标:
 * 1. 掌握 sizeof 运算符语法：sizeof(类型名) 与 sizeof 变量名
 * 2. 在本地计算机上实测各基础数据类型的物理内存字节数
...
int main(void)
{
    ...
    // 2. 测量核心 C 语言基本数据类型规格 (sizeof(类型名))
    printf("[Part 2] 测量核心基本数据类型规格 (sizeof(类型名)):\n");
    printf("  --------------------------------------------------\n");
